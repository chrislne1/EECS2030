...
public class TestRefurbishedStore {
	...
	public void test_refurbished_store_1() {
		//Initialize test products nd input into the entry
		...
		//Entry 3
		rs.addEntry("7Y@M4PFZ779UB", "iPad Pro 10.5", 929.00);
		assertTrue(rs.getNumberOfEntries() == 3);
		assertTrue(rs.getPrivateEntriesArray().length == 5);
		assertTrue(rs.getPrivateEntriesArray()[0] == e1);
		assertTrue(rs.getPrivateEntriesArray()[1].getSerialNumber().equals("C9FZN4J8QC82"));
		assertTrue(rs.getPrivateEntriesArray()[1].getProduct() == p2);
		assertTrue(rs.getPrivateEntriesArray()[2].getSerialNumber() .equals("7Y@M4PFZ779UB"));
		assertTrue(rs.getPrivateEntriesArray()[2].getProduct().getModel().equals("iPad Pro 10.5"));
		assertEquals(929.00, rs.getPrivateEntriesArray()[2].getProduct().getOrigonalPrice(), 0.1);
		assertTrue(rs.getPrivateEntriesArray()[3] == null);
		assertTrue(rs.getPrivateEntriesArray()[4] == null);
		...
		//		assertTrue(rs.getPrivateEntriesArray()[1].getSerialNumber().equals("C9FZN4J8QC82"));
		//		assertTrue(rs.getPrivateEntriesArray()[1].getProduct() == p2);
		assertTrue(rs.getEntries()[2].getSerialNumber() .equals("7Y@M4PFZ779UB"));
		assertTrue(rs.getEntries()[2].getProduct().getModel().equals("iPad Pro 10.5"));
		assertEquals(929.00, rs.getEntries()[2].getProduct().getOrigonalPrice(), 0.1);
	...
	public void test_refurbished_store_2() {
		...
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getModel().equals("iPad Pro 10.5"));
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getFinish() == null);
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getStorage() == 0);
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").hasCellularConnectivity() == false);
		assertEquals(929.00, rs.getProduct("7Y@M4PFZ779UB").getOrigonalPrice(), 0.1);
		assertEquals(0.0, rs.getProduct("7Y@M4PFZ779UB").getDiscountValue(), 0.1);

		rs.getProduct("7Y@M4PFZ779UB").setFinish("Silver");
		rs.getProduct("7Y@M4PFZ779UB").setStorage(256);
		...
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getModel().equals("iPad Pro 10.5"));
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getFinish() == "Silver");
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").getStorage() == 256.0);
		assertTrue(rs.getProduct("7Y@M4PFZ779UB").hasCellularConnectivity() == false);
		assertEquals(929.00, rs.getProduct("7Y@M4PFZ779UB").getOrigonalPrice(), 0.1);
		assertEquals(270.0, rs.getProduct("7Y@M4PFZ779UB").getDiscountValue(), 0.1);
	}
	...
	public void test_refurbished_store_3() {
		...
		assertTrue(rs.getSpaceGreyOrPro()[0].equals("F9FDN4NKQ1GC")
				&& rs.getSpaceGreyOrPro()[1].equals("7Y@M4PFZ779UB"));
